...
Rules for carrying context between agent sessions via handoff files: every invocation is a fresh session, session
resume is abandoned, and heavy content stays out of orchestrator contexts.
