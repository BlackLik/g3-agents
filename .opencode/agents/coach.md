...
- Beyond-diff context (conventions, duplicates, callers, surrounding code) comes from `@explore` first — one aggregated query; direct reads only pin-verify a specific explore finding
